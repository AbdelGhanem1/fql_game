...
echo "=========================================="
echo "RunPod Online Index: $JOB_INDEX"
...
"$PYTHON_EXEC" main.py \
    ...
    --save_dir="/models/saved_models/runpod_upload"
