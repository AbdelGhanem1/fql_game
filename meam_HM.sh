...
# Usage: ./run_humanoidmaze.sh [JOB_INDEX]
JOB_INDEX=${1:-0}

# ==============================================================================
# 1. PARAMETER SELECTION
# ==============================================================================
SEEDS=(10001 20002 40004 50005)
# Humanoidmaze evaluated across tasks 2, 3, and 5 based on your logs
TASKS=(1 2 3 4 5)
...
# --- SET ONLINE STEPS BASED ON TASK ID ---
ONLINE_STEPS=0
...
echo "Steps: Offline=1000000 | Online=$ONLINE_STEPS"
echo "=========================================="
...
export WANDB_PROJECT="MEAM_HM_main_no_score_minimizaiton"
